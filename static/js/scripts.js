...
function handleFailedConnection() {
    ...
    alert('It looks like Control Lab IO is having a bit of trouble connecting to the LEGO Interface B right now. Please try again.'); // Optionally, show an alert message
}
